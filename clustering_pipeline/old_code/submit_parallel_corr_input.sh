...
#SBATCH --ntasks=4            # use this many tasks
...
#SBATCH --exclusive
#SBATCH -t 30:00:00 # max run time
...
# Run the program
mpiexec -n $SLURM_NTASKS python3 /cosma/home/dp004/dc-prye1/4fs_clustering_project/clustering_pipeline/parallel_corr_input.py
